...
vim.keymap.set("n", "3", function() harpoon:list():select(7) end,{ buffer = 0 })
vim.keymap.set("n", "4", function() harpoon:list():select(8) end,{ buffer = 0 })
vim.keymap.set("n", "5", function() harpoon:list():select(9) end,{ buffer = 0 })
-- stylua: ignore end
